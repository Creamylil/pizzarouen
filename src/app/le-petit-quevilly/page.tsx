...
export default async function LePetitQuevillyPage() {
  ...
  const cityPizzerias = pizzerias.filter(p => extractPostalCode(p.address) === '76140');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-gray-100">
      <JsonLdScript data={generateItemListSchema(listPizzerias, 'Pizzerias au Petit-Quevilly')} />
      <JsonLdScript data={generateBreadcrumbSchema([
        { name: 'Pizza Rouen', url: 'https://pizzarouen.fr' },
        { name: 'Pizza Le Petit-Quevilly', url: 'https://pizzarouen.fr/le-petit-quevilly' },
      ])} />
