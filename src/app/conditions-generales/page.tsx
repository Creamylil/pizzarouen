...
export const metadata: Metadata = {
  ...
  description: 'Conditions générales d\'utilisation du site pizzarouen.fr',
  alternates: { canonical: 'https://pizzarouen.fr/conditions-generales' },
};
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <p>Les présentes conditions générales régissent l&apos;utilisation du site pizzarouen.fr, annuaire en ligne de pizzerias dans la région de Rouen.</p>
          ...
          <p>Le site propose un annuaire référençant les pizzerias de Rouen et de sa région. Les informations (horaires, adresses, services) sont fournies à titre indicatif.</p>

          <h2 className="text-2xl font-bold text-gray-900">4. Responsabilité</h2>
          <p>Pizza Rouen s&apos;efforce de fournir des informations exactes et à jour. Toutefois, nous ne pouvons garantir l&apos;exactitude ou l&apos;exhaustivité des informations affichées.</p>
          ...
          <p>Pour toute question concernant ces conditions, contactez-nous à contact@pizzarouen.fr.</p>
        </div>
      </div>
    </div>
  );
